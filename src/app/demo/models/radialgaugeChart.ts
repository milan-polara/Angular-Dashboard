...
export class RadialGauge {
    ...
    loadData() {
        ...
        interval((e) => {
            ...
            this.value = this.getRandomArbitrary(
                this.upperLimit,
                this.lowerLimit
            );
            this.svg
                ...
                .attrTween("transform", (d, i, a) => {
                    ...
                    if (this.needleAngleOld + this.startAngle > this.endAngle) {
                        this.needleAngleOld = this.endAngle - this.startAngle;
                    }
                    if (
                    ...
                    if (this.needleAngleNew + this.startAngle > this.endAngle) {
                        this.needleAngleNew = this.endAngle - this.startAngle;
                    }
                    if (
